...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    public void start() {
        ...
        mNinjaOSSettingsObserver.observe();
        mNinjaOSSettingsObserver.update();
    ...
    private NinjaOSSettingsObserver mNinjaOSSettingsObserver = new NinjOSSettingsObserver(mHandler);

    private class NinjaOSSettingsObserver extends ContentObserver {
        NinjaOSSettingsObserver(Handler handler) {
            super(handler);
        }
